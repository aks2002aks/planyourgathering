...
export default function Intro() {
  ...
  return (
    <div className="bg-white  items-center justify-center overflow-hidden relative  lg:hidden">
      <div className="overflow-hidden relative z-1 h-[40vh] sm:h-[50vh] md:h-[60vh]">
        <motion.img
